...
`FrameReader`. [TRACK_RUNNER_DESIGN.md](../TRACK_RUNNER_DESIGN.md)
...
short-term** from [REPO_STYLE.md](../REPO_STYLE.md).
...
([size_spike_hardening_evidence.md](../active_plans/decisions/size_spike_hardening_evidence.md))
...
Test placement follows [PYTEST_STYLE.md](../PYTEST_STYLE.md):
...
- Active plan tracker: publish this plan to
  `docs/archive/interaction_shell_and_trajectory_truth.md` at execution
