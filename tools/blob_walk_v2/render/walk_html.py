...
def build_walk_html(run_root: pathlib.Path) -> pathlib.Path:
	...
	out.append(f'    <li><span class="swatch" style="background: {_WALK_PALETTE["velocity_vector"]};"></span>Velocity vector (arrow)</li>')
	out.append(f'    <li><span class="swatch" style="background: {_WALK_PALETTE["allowed_jump_circle"]};"></span>Allowed-jump circle (dashed)</li>')
