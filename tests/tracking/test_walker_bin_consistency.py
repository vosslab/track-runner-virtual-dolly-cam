...
#============================================
def test_warp_scale_uses_bin_factor() -> None:
	...
	def spy_build_warp(st: object, fn: object, fo: object, sf: object) -> object:
...
#============================================
def test_dog_diameter_override_is_post_bin_at_bin4() -> None:
	...
	def spy_dog_filter(residual: object, diameter: object, **kwargs) -> object:
...
#============================================
def test_roi_clamp_space_mismatch_regression() -> None:
...
#============================================
def test_seeds_view_bin_factor_mismatch_guard() -> None:
