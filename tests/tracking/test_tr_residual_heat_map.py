...
Tests for compute_heat_map_roi and compute_heat_map_overlay_roi verify
behavioral output bounds, shape, and alpha handling.
...
class _FakeReader:
	...
	def __init__(self, frames: list[object]) -> None:
		"""Store BGR frames and expose the FrameReader-compatible interface."""
	...
	#============================================
	def read_frame(self, frame_index: int) -> object | None:
...
#============================================
def test_facade_output_is_roi_scoped_not_full_frame() -> None:
...
#============================================
def test_compute_roi_off_frame_prediction_never_inverts_bounds() -> None:
...
#============================================
def test_compute_residual_bails_on_degenerate_roi() -> None:
...
#============================================
def test_compute_heat_map_overlay_roi_returns_bgra_with_proper_alpha() -> None:
