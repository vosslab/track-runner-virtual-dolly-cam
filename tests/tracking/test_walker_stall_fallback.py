...
def test_seed_only_accepted_pass_falls_back_to_hermite(
	...
	Uses an 8-frame unit interval: the seed is accepted at bootstrap and the
	seven remaining frames are soft misses.
	"""
	_stub_collaborators(monkeypatch)
...
#============================================
def test_accepted_pass_keeps_walker_path(monkeypatch: pytest.MonkeyPatch) -> None:
