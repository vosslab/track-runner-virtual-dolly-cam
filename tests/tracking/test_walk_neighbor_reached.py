...
#============================================
def test_stride1_fwd_walk_observes_interior_only() -> None:
...
#============================================
def test_stride2_even_span_lands_exactly_clamp_is_noop() -> None:
...
#============================================
def test_stride2_odd_span_crossing_detected_and_clamped_fwd() -> None:
...
#============================================
def test_stride2_odd_span_crossing_detected_and_clamped_bwd() -> None:
...
#============================================
def test_span_smaller_than_stride_terminates_immediately() -> None:
