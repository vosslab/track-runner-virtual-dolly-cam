...
def test_warp_scale_uses_bin_factor() -> None:
	...
	def spy_build_warp(st: object, fn: int, fo: int, sf: float) -> object:
...
#   test_observe_blob_at_processed_contract.py


#============================================
def test_residual_compute_non_empty_at_bin_4() -> None:
...
#============================================
def test_roi_clamp_space_mismatch_fix_bin4_right_of_center() -> None:
...
#============================================
def test_roi_clamp_noop_at_bin1() -> None:
