...
def _make_geometry(source_width: int, source_height: int, bin_factor: int) -> common_tools.frame_reader.FrameGeometry:
...
def test_source_point_round_trip(bin_factor: int) -> None:
...
@pytest.mark.parametrize("bin_factor", [1, 2, 4])
def test_source_box_round_trip(bin_factor: int) -> None:
...
def test_source_box_edges_midpoint_and_span() -> None:
...
def test_processed_box_edges_midpoint_and_span() -> None:
...
def test_in_bounds_just_inside() -> None:
...
def test_in_bounds_at_processed_width_is_false() -> None:
...
def test_in_bounds_at_processed_height_is_false() -> None:
...
def test_in_bounds_negative_is_false() -> None:
...
def test_processed_box_in_bounds_uses_center() -> None:
...
def test_processed_point_has_no_to_processed() -> None:
...
def test_source_point_has_no_to_source() -> None:
...
def test_processed_box_has_no_to_processed() -> None:
...
def test_source_box_has_no_to_source() -> None:
...
def test_require_source_point_passes_correct_type() -> None:
...
def test_require_source_point_raises_for_wrong_type() -> None:
...
def test_require_processed_point_passes_correct_type() -> None:
...
def test_require_processed_point_raises_for_wrong_type() -> None:
...
def test_require_source_box_passes_correct_type() -> None:
...
def test_require_source_box_raises_for_wrong_type() -> None:
...
def test_require_processed_box_passes_correct_type() -> None:
...
def test_require_processed_box_raises_for_wrong_type() -> None:
...
def test_sentinel_source_box_round_trip_asymmetric() -> None:
...
def test_sentinel_edges_no_axis_swap() -> None:
...
def test_sentinel_processed_box_to_source_scale_not_doubled() -> None:
