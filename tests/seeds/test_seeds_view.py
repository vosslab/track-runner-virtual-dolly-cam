...
#============================================
def test_view_processed_coords_at_bin1() -> None:
...
#============================================
def test_view_processed_coords_at_bin4() -> None:
...
#============================================
def test_view_assert_geometry_mismatch_raises() -> None:
...
#============================================
def test_view_source_accessor_unchanged() -> None:
...
#============================================
def test_view_lazy_evaluation() -> None:
