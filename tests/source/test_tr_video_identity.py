...
#============================================
def test_rename_only_is_informational() -> None:
...
#============================================
def test_size_bytes_change_only_is_informational() -> None:
...
#============================================
def test_frame_count_mismatch_is_blocking() -> None:
...
#============================================
def test_width_mismatch_is_blocking() -> None:
...
#============================================
def test_height_mismatch_is_blocking() -> None:
...
#============================================
def test_fps_within_tolerance_is_clean() -> None:
...
#============================================
def test_fps_remux_precision_within_1fps_tolerance_is_clean() -> None:
...
#============================================
def test_fps_large_change_is_informational() -> None:
...
#============================================
def test_duration_within_tolerance_is_clean() -> None:
...
#============================================
def test_duration_beyond_tolerance_is_informational() -> None:
...
#============================================
def test_summarize_mismatches_lists_blocking_first() -> None:
...
#============================================
def test_summarize_mismatches_empty_result() -> None:
...
#============================================
def test_missing_fields_raise_key_error() -> None:
...
#============================================
def test_fastread_remux_bucket_assignments() -> None:
	...
	remuxed = {
		"basename": "runner_source-fastread.mkv",
