...
#============================================
def test_powers_of_two_are_good() -> None:
...
#============================================
def test_small_smooth_sizes() -> None:
...
#============================================
def test_anchors_from_plan() -> None:
...
#============================================
def test_largest_goodbox_examples() -> None:
...
#============================================
def test_largest_goodbox_idempotent() -> None:
...
#============================================
def test_prime_factor_too_large() -> None:
...
#============================================
def test_alignment_thresholds() -> None:
...
#============================================
def test_is_good_size_rejects_zero() -> None:
	with pytest.raises(ValueError):
		goodbox.is_good_size(0)


#============================================
def test_is_good_size_rejects_negative() -> None:
	with pytest.raises(ValueError):
		goodbox.is_good_size(-4)


#============================================
def test_largest_goodbox_rejects_small() -> None:
	with pytest.raises(ValueError):
...
#============================================
def test_is_good_size_type_error() -> None:
