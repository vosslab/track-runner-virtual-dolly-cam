...
class _FakeCapture:
	...
	def __init__(self, total_frames: int, frame_shape: tuple[int, int, int]) -> None:
...
#============================================
def _make_reader(total_frames: int = 10) -> object:
...
#============================================
def test_read_frame_eof_raises_runtime_error() -> None:
...
#============================================
def test_read_frame_normal_returns_ndarray() -> None:
