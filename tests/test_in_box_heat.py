...
# make common_tools importable when pytest runs from tests/
...
#============================================
def test_hot_pixels_mean_and_count_only_above_threshold():
...
#============================================
def test_all_below_threshold_returns_sentinel():
...
#============================================
def test_fractional_center_named_pixels():
...
#============================================
def test_zero_area_and_out_of_roi_box_no_crash():
...
#============================================
def test_above_threshold_but_invalid_pixel_excluded():
...
#============================================
def test_wrong_space_box_raises():
