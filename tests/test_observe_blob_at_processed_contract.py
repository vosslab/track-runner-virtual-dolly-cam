...
#============================================
def _make_precomputed_store(roi: tuple, proc_h: int, proc_w: int) -> dict:
...
#============================================
def test_roi_override_processed_no_conversion():
...
#============================================
def test_dog_diameter_override_processed_no_conversion():
