...
def test_right_edge_exit_pinning():
...
def test_left_edge_exit_pinning():
...
def test_stable_size_is_bracketing_mean():
...
def test_cy_linear_interpolation():
...
def test_single_bracket_open_ended_span():
...
def test_tie_favoring_left_right():
...
def test_pre_race_nif_raises_error():
