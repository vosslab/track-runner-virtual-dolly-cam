...
#============================================
def test_render_race_start_contact_sheet_happy_path(tmp_path):
...
#============================================
def test_render_race_start_contact_sheet_frame_read_failure(tmp_path):
...
#============================================
def test_render_race_start_contact_sheet_tile_count_validation(tmp_path):
...
#============================================
def test_padding_edge_clamped_crop(tmp_path):
