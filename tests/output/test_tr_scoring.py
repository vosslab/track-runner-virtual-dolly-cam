...
#============================================
def test_velocity_consistency_smooth_curve() -> None:
...
#============================================
def test_velocity_consistency_jerky() -> None:
...
#============================================
def test_velocity_consistency_stationary_bounded() -> None:
...
#============================================
def test_velocity_consistency_short_track() -> None:
...
#============================================
def test_fps_threaded_through_scoring() -> None:
...
#============================================
def test_owner_agreement_debug_matches_aggregate() -> None:
	"""Confidence-owner debug output returns its aggregate agreement."""
	fwd = _make_track([(10.0, 10.0), (12.0, 10.0), (14.0, 10.0)])
	bwd = _make_track([(11.0, 10.0), (12.0, 10.0), (13.0, 10.0)])
	agg = trajectory_confidence.interval_agreement(fwd, bwd)
	debug = trajectory_confidence.compute_agreement_debug(fwd, bwd, start_frame=100)
	assert abs(agg - debug["agreement"]) < 1e-9
	# percentiles ordered low->high
	assert debug["confidence_p10"] <= debug["confidence_p50"] <= debug["confidence_p90"]
