...
#============================================
def test_analytical_solve_produces_blended_path() -> None:
...
#============================================
def test_diagnostics_v3_write_and_read(tmp_path: pathlib.Path) -> None:
	...
	# write
	state_io.write_solver_interval_scores(
		diagnostics, diag_path, fps=30.0,
	)
	# read back
	loaded = state_io.load_interval_scores(diag_path)
...
#============================================
def test_review_handles_v3_confidence() -> None:
...
#============================================
def test_solve_all_intervals_calls_on_interval_solved() -> None:
...
#============================================
def test_hermite_only_solve_populates_diagnostics() -> None:
